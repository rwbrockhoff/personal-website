...
import dbSchemaDiagram from '@assets/blog/data-analytics/salka-designs-automated-etl/salka-db-schema.png';
import emailPreview from '@assets/blog/data-analytics/salka-designs-automated-etl/salka-reports-email-preview.png';
import vpcDiagram from '@assets/blog/data-analytics/salka-designs-automated-etl/salka-vpc-diagram.png';
...
<BlogImage src={dbSchemaDiagram} alt="Database schema for RDS PostgreSQL instance" />
...
<BlogImage
  src={vpcDiagram}
  alt="AWS VPC diagram illustrating security design for AWS services"
  fullSize
/>
...
<BlogImage
  src={emailPreview}
  alt="Email preview for final deliverable to client via AWS SES"
  caption="Email delivered via Amazon SES with .xlsx file using a presigned URL"
  fullSize
/>
